        ...
        <div class="row mt">
                <div class="form-panel">
                    <div class=" form">
                        ...
                        <form class="cmxform form-horizontal style-form"  method="post" action="{{route('user.update.photo')}}" files="true" enctype="multipart/form-data">
                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            <h2 class="violet">Update Photo ID</h2>
                            <hr>
                                ...
                                <div class="col-lg-10">
                                      <div class="fileupload fileupload-new" data-provides="fileupload">
                                          <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                              <img src="{{URL::asset('img-photo')}}/{{$user->userphoto->filename}}" alt="{{$user->userphoto->filename}}">
                                          </div>
